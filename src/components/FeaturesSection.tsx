          ...
          <div className="relative z-10 p-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="299" height="139" fill="none" className="mx-auto w-full h-auto">
              <g transform="translate(0.878 1.408)">
                ...
                {/* Brain icon in the center - replaced with simpler version */}
                <g transform="translate(120 40)">
                  <circle cx="20" cy="20" r="20" fill="rgb(255,255,255)" stroke-width="0.987805" stroke="rgb(244,244,245)" stroke-miterlimit="10" />
                  <path d="M10,17.5C10,11.977,14.477,7.5,20,7.5S30,11.977,30,17.5c0,2.784-1.142,5.307-2.988,7.138c0.877,0.644,1.633,1.509,2.173,2.524c0.144,0.33,0.137,0.71-0.018,1.033 c-0.156,0.324-0.456,0.541-0.812,0.585C28.29,28.78,28.147,28.787,28,28.787c-0.615,0-1.214-0.177-1.728-0.51 c-1.221,0.993-2.77,1.586-4.46,1.586h-3.624c-1.69,0-3.239-0.593-4.461-1.586c-0.513,0.333-1.111,0.51-1.727,0.51 c-0.143,0-0.285-0.012-0.427-0.035c-0.351-0.059-0.653-0.266-0.808-0.583c-0.156-0.317-0.164-0.697-0.023-1.021 c0.544-1.02,1.305-1.887,2.187-2.531C11.15,22.797,10,20.279,10,17.5z M17.5,9.5v6c0,0.552-0.448,1-1,1s-1-0.448-1-1v-6 c0-0.552,0.448-1,1-1S17.5,8.948,17.5,9.5z M22.5,9.5v6c0,0.552,0.448,1,1,1s1-0.448,1-1v-6c0-0.552-0.448-1-1-1 S22.5,8.948,22.5,9.5z" fill="#666666" stroke="none"/>
                </g>
